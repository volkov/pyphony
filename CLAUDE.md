...
**Важно:** при изменении функциональности обновляй соответствующие спецификации. Если добавляешь новую подсистему — добавь спеку в `specs/` и ссылку в `spec.md`. Используй skill `write-spec` для создания и обновления спек.
